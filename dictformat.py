...
try:
    with open('nasadata.json', 'r') as file:
        nasadata = json.load(file)
        print(file)
except:
    print("Data not found or either corrupted, restart the application")
...
# sample data
{
    ...
    "hdurl": "https://apod.nasa.gov/apod/image/2608/mwyellowstone_lane_1800.jpg",
    "media_type": "image",
    "service_version": "v1",
    "title": "Milky Way over Yellowstone",
    "url": "https://apod.nasa.gov/apod/image/2608/mwyellowstone_lane_960.jpg"
}


picture = nasadata["hdurl"]
...
# This file was a draft for Tkinter
